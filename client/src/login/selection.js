        ...
        <Column flexGrow={1}>
          ...
          <Row vertical="center">
            <Column flexGrow={1} horizontal="center">
              <Header2 id="exerciseGridDesc"> Exercise Grid </Header2>
              <Body>
                {" "}
                Use the exercise grid to keep track of your daily workouts!{" "}
              </Body>
              <Body>
                {" "}
                Just enter the name of the exercise, what you did, and when you
                did it.
              </Body>
              <Body>
                {" "}
                StayFit! will take care of the rest! Choose to organize your
                grid by
              </Body>
              <Body>
                {" "}
                the name of your exercise, or the date you did it on.{" "}
              </Body>
            </Column>
            <Column flexGrow={1} horizontal="center">
              <Header2 id="mealPlannerDesc"> Meal Planner </Header2>
              <Body>
                {" "}
                Use the meal planner to generate a meal plan for your day!{" "}
              </Body>
              <Body>
                {" "}
                Start by calculating your required calorie intake for{" "}
              </Body>
              <Body>
                {" "}
                each day. Then, we will generate a custom meal plan for you.{" "}
              </Body>
              <Body>
                {" "}
                You will then be able to view your meal plan and its nutrition
                info!{" "}
              </Body>
            </Column>
          </Row>
